 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_test.h 736 2010-11-07 13:10:25Z ertl-honda $
 */
 ...
 *  チップで共通な定義
 */
#define CPUEXC1				0x10001		/* 未定義命令例外 */
#define CPUEXC2				0x20001		/* 未定義命令例外 */
#define CPUEXC3				0x30001		/* 未定義命令例外 */
#define CPUEXC4				0x40001		/* 未定義命令例外 */
