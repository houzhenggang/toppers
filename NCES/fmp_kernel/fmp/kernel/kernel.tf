...
$   の責任を負わない．
$ 
$   @(#) $Id: kernel.tf 775 2011-01-31 13:36:35Z ertl-honda $
$  
$ =====================================================================
...
$ 	// istkszがスタック領域のサイズとして正しくない場合（E_PAR）
	$IF !EQ(ICS.ISTK[icsid], "NULL") && LENGTH(CHECK_STKSZ_ALIGN)
