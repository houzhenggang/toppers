 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: dataqueue.h 378 2009-09-11 16:21:24Z ertl-honda $
 */
...
/*
 *  データキュー管理ブロックへのポインタテーブル（kernel_cfg.c）
 */
 ...
 */
#define	DTQID(p_dtqcb)	((ID)(((p_dtqcb->p_dtqinib) - dtqinib_table) + TMIN_DTQID))
 ...
 *  データキューからのデータ受信
 */
extern bool_t	receive_data(DTQCB *p_dtqcb, intptr_t *p_data, bool_t *p_dspreq);
