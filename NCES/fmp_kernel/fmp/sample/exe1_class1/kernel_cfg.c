...
static STK_T _kernel_stack_MAIN_TASK[COUNT_STK_T(STACK_SIZE)]  __attribute__((section(".bss._kernel_prc1s_tstack"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (intptr_t)(0), (main_task), INT_PRIORITY(MAIN_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_MAIN_TASK, (TA_NULL), (NULL), 1, (uint_t)(0x0000000f) }
};
...
TCB _kernel_tcb_MAIN_TASK	__attribute__((section(".bss._kernel_prc1s_tskcb"),nocommon));
...
TCB* const _kernel_p_tcb_table[TNUM_TSKID] ={
	...
	&_kernel_tcb_TASK2,
	&_kernel_tcb_TASK3,
	&_kernel_tcb_MAIN_TASK
};

const ID _kernel_torder_table[TNUM_TSKID] = {
	LOGTASK1, LOGTASK2, TASK1, TASK2, TASK3, MAIN_TASK
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	{ (TA_NULL), (intptr_t)(0), (cyclic_handler), (100), (0), 1, (uint_t)(0x0000000f) }
};
...
const ALMINIB _kernel_alminib_table[TNUM_ALMID] = {
	{ (TA_NULL), (intptr_t)(0), (alarm_handler), 1, (uint_t)(0x0000000f) }
};
