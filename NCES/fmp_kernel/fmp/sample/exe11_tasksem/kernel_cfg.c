...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (intptr_t)(1), (task), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK1, (TA_NULL), (NULL), 1, (uint_t)(0x0000000f) },
...
const SEMINIB _kernel_seminib_table[TNUM_SEMID] = {
	...
	{ (TA_NULL), (&(_kernel_prc1_pcb.obj_lock)), (1), (1) }
};
...
SEMCB _kernel_semcb_SEM1 __attribute__((section(".bss._kernel_prc1s_objcb"),nocommon));
