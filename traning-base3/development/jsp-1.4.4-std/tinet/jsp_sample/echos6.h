 ...
 * 
 *  @(#) $Id: echos6.h,v 1.5 2009/12/24 05:40:11 abe Exp abe $
 */
...
extern UB tcp_echo_srv_swbuf[];
extern UB tcp_echo_srv_rwbuf[];

/*
 *  タスク
 */

extern void tcp_echo_srv_task(VP_INT exinf);

/*
 *  関数
 */

extern ER callback_nblk_tcp_echo_srv (ID cepid, FN fncd, VP p_parblk);

#endif	/* of #ifndef _MACRO_ONLY */

#endif	/* of #ifndef _ECHOS_H_ */
