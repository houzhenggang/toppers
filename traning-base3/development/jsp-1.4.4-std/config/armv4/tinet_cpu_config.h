...
#define IP4_CFG_FRAG_REASSM_SIZE	4096	/* 再構成バッファサイズ				*/
...
#define NUM_MPF_NET_BUF_REASSM	2	/* 再構成バッファサイズ	*/
...
#ifndef NUM_MPF_NET_BUF_64
#define NUM_MPF_NET_BUF_64	1	/* 64 オクテット	*/
#endif	/* of #ifndef NUM_MPF_NET_BUF_64 */

#ifndef NUM_MPF_NET_BUF_128
#define NUM_MPF_NET_BUF_128	1	/* 128 オクテット、2 以上	*/
#endif	/* of #ifndef NUM_MPF_NET_BUF_128 */
