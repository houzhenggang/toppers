...
#define TNUM_CORE_INTNO		8

/*
 *  MIPS32コアのステータスレジスタに設定可能な最高割込み許可ビットパターン
 */
#define MAX_IPM  0xff

/*
 *  MIPS32コアに設定する割込みマスクのチェック
 */
