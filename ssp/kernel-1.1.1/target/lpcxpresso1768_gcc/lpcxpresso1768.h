...
/**
 * \ingroup TOPPERS_ASP
 * \defgroup TOPPERS_TARGET LPCXpresso 1768 ターゲット依存部
 */
/* \{ */
/**
 * \file lpcxpresso1768.h
...
/**
 * \mainpage
 * NXP社LPCXpersso 1768用のターゲット依存部。TOPPERS/ASPターゲット非依存部1.6に対応している。
 *
 ...
 * \endcode
 *
 * この依存部は、ROM化コードのみ生成する。SRAM上で動作するコードは生成しない。
 */

#ifndef TOPPERS_LPCXPRESSO1768_H
#define TOPPERS_LPCXPRESSO1768_H
