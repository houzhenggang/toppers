...
#elif (SIO_PORTID == 2)
#define INHNO_SIO_TX		INT_MFS1_TX
#define INTNO_SIO_TX		INT_MFS1_TX
#define INHNO_SIO_RX		INT_MFS1_RX
#define INTNO_SIO_RX		INT_MFS1_RX

#elif (SIO_PORTID == 3)
#define INHNO_SIO_TX		INT_MFS2_TX
#define INTNO_SIO_TX		INT_MFS2_TX
#define INHNO_SIO_RX		INT_MFS2_RX
#define INTNO_SIO_RX		INT_MFS2_RX
